...
class DataModel {
    ...
    factory DataModel.fromJson(Map<String, dynamic> json) => DataModel(
        ...
        links: DataModelLinks.fromJson(json["links"]),
...
class DataModelLinks {
    ...
    factory DataModelLinks.fromJson(Map<String, dynamic> json) => DataModelLinks(
        self: json["self"],
        html: json["html"],
...
class TopicSubmissions {
    ...
    factory TopicSubmissions.fromJson(Map<String, dynamic> json) => TopicSubmissions(
        digitalNomad: json["digital-nomad"] == null ? null : DigitalNomad.fromJson(json["digital-nomad"]),
        architecture: json["architecture"] == null ? null : Architecture.fromJson(json["architecture"]),
    );
